...
- Name: auth-phases.spec.js >> Phase 5 — Session persistence on refresh >> page reload keeps user authenticated — stays on /home
- Location: tests/auth-phases.spec.js:235:3
