...
- Name: auth-phases.spec.js >> Phase 4 — RLS: user sees only their own events >> add-event page is reachable and pre-fills for current user
- Location: tests/auth-phases.spec.js:219:3
