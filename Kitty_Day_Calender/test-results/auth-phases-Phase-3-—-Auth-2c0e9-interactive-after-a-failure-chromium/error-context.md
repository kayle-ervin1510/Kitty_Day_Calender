...
- Name: auth-phases.spec.js >> Phase 3 — Auth failure >> sign-in form is still interactive after a failure
- Location: tests/auth-phases.spec.js:169:3
