...
- Name: auth-phases.spec.js >> Phase 5 — Session persistence on refresh >> page reload on /calendar keeps user authenticated
- Location: tests/auth-phases.spec.js:247:3
