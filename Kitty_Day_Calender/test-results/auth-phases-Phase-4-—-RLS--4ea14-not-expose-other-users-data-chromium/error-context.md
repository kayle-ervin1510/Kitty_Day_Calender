...
- Name: auth-phases.spec.js >> Phase 4 — RLS: user sees only their own events >> litter box is accessible and does not expose other users data
- Location: tests/auth-phases.spec.js:210:3
